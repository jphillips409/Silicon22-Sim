...
gROOT->ForceStyle();
 ...
 TCanvas canvas("level_23P_Holt");
  ...
  TBox box43(xmin23P,E-.84/2,xmax23P,E+.84/2);
  ...
  E = 1.68 + .386;
  ll.DrawLine(xmin21Al,E,xmax21Al,E);
  TBox box13(xmin21Al,E-.57/2,xmax21Al,E+.57/2);
  ...
  tt.DrawLatex(.153-.3,2.2,"^{23}P");


  tt.DrawLatex(-.23,2.81,"1/2^{+}");


  tt.SetTextSize(.08);
  tt.DrawLatex(.38,3.6,"SM");
  ...
  arrow.DrawArrow(xmax23P,2.644,xmin22Si+.06,-.004);
