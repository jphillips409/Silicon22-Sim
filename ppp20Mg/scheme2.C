...
gROOT->ForceStyle();
 ...
 TCanvas canvas("level_22Si_HoltMichel_2");

 TH2S frame("frame","",10,0,3.3,10,-1,4.);
  ...
  ll.SetLineColor(3);
  ll.DrawLine(1.8+shift,0,2.+shift,0);
  ll.DrawLine(1.8+shift,2.28,2.+shift,2.28);
  ...
  ll.DrawLine(2.3+shift,0,2.4+shift,0.);

  ll.DrawLine(1.7+shift,2.791,1.8+shift,2.24);
  ll.DrawLine(2.+shift,2.28,2.1+shift,1.74);
  ll.DrawLine(2.3+shift,1.74,2.4+shift,3.199);
  ...
  tt.DrawLatex(1.62+shift+.1,3.47,"^{22}Si");
  tt.DrawLatex(2.11+shift+.3,3.47,"^{22}O");
  ...
  tt.DrawLatex(2.09+ss+.28,-.49,"GSM");
  tt.SetTextColor(1);
  tt.DrawLatex(1.76,1.29,"(1/2^{+})");  
  tt.SetTextColor(3);
  //tt.SetTextAngle(90);
  tt.DrawLatex(2.25,-.8,"USDCm");
