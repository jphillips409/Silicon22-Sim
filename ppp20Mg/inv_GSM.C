{
 gROOT->Reset();
  ...
  gROOT->ForceStyle();
  TCanvas canvas("inv_22Si_GSM","",600,800);
  canvas.Divide(1,2);

  canvas.cd(1);
  TFile file_GSM("sim_GSM.root");
  TH1I * hist_GSM = (TH1I*) file_GSM.Get("Erel");

  TFile file_Holt("sim_Holt.root");
  TH1I * hist_Holt = (TH1I*) file_Holt.Get("Erel");

  TH2S frame("frame","",10,0,6,10,0,6000);
