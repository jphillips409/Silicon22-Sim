...
const double mass_20Mg = 22.422;
const double mass_22Al = 18.200;
const double mass_22Si = 33.338;
const double mass_23Si = 23.697;
const double mass_24Si = 10.745195;
const double mass_26S = 27.079;
const double mass_27S = 17.028;
const double mass_28S = 4.073206;
const double mass_31Ar = 11.325;
const double mass_30Ar = 20.931147;
//total masses
...
const double Mass_26S = 26.*m0 + mass_26S;
const double Mass_27S = 27.*m0 + mass_27S;
const double Mass_28S = 28.*m0 + mass_28S;
const double Mass_30Ar = 30.*m0 + mass_30Ar;
const double Mass_31Ar = 31.*m0 + mass_31Ar;
#endif
