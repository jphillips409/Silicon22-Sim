...
class CDecay
{
 public:
  ...
  void ModeOneHalf_Holt();
  void ModeThreeHalves_Holt();
  void ModeFiveHalves_Holt();

  void ModeOneHalf_GSM();
  void ModeThreeHalves_GSM();
  void ModeThreeHalfMinus_Pierre();
  void ModeFiveHalves_GSM();
