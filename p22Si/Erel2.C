{
  ...
  TArrow arrow;
  arrow.SetAngle(30);
  arrow.DrawArrow(2.1,55,2.1,46);
  arrow.DrawArrow(3.7,30,3.7,22);
  //arrow.DrawArrow(2.327,80,2.327,30);
  //arrow.DrawArrow(.694,150,.694,60);

  TLatex tt;
  tt.DrawLatex(2.3,50,"1/2^{+}");
  tt.DrawLatex(3.55,31.6,"5/2^{+}");
  // tt.DrawLatex(2.258,91,"3/2^{+}");
  //tt.DrawLatex(.629,177,"3/2^{+}");
  tt.DrawLatex(4,42,"^{23}P#rightarrow#it{p}+^{22}Si");
}
