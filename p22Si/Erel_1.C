{
  ...
  gROOT->ForceStyle();
  TCanvas canvas("Erel_23P_1","",600,800);
  ...
  TH2S frame("frame","",10,0,6.5,10,0,120);
  ...
  arrow.DrawArrow(2.08,119,2.08,101);
  ...
  TLatex tt;
  tt.SetTextSize(.07);
  tt.DrawLatex(2.38,107,"1/2^{+}");
  tt.DrawLatex(3.37,64,"5/2^{+}");
  // tt.DrawLatex(2.258,91,"3/2^{+}");
  //tt.DrawLatex(.629,177,"3/2^{+}");
  tt.DrawLatex(3.5,100,"(a) ^{23}P#rightarrow#it{p}+^{22}Si");
