{
  ...
  tt.DrawLatex(3.1,80,"#splitline{(a) ^{23}P#rightarrow#it{p}+^{22}Si}{     85 MeV/A}");
  tt.DrawLatex(3.1,55,"     87 mm");

  canvas.cd(2);
  TH2S frame2("frame2","",10,0,6.5,10,0,130);
  ...
  hist3->Rebin(25);
  hist3->Draw("same"); 
  tt.DrawLatex(3.5,100,"(b) 100 mm");

  canvas.cd(3);
  TH2S frame3("frame3","",10,0,6.5,10,0,130);
  ...
  hist4->Rebin(25);
  hist4->Draw("same"); 
  tt.DrawLatex(3.5,100,"(c) 110 mm");

  canvas.cd(4);
  TH2S frame4("frame4","",10,0,6.5,10,0,130);
  ...
  hist5->Rebin(25);
  hist5->Draw("same"); 
  tt.DrawLatex(3.5,100,"(d) 120 mm");

  canvas.cd(5);
  TH2S frame5("frame5","",10,0,6.5,10,0,130);
