...
gROOT->ForceStyle();
 ...
 TH1I* hist_20Mg = (TH1I*) file.Get("rigidity_20Mg_before");
 TH1I* hist_20Mg_after = (TH1I*) file.Get("rigidity_20Mg");

 TH2S frame("frame","",10,2.1,2.4,10,0,1400);
 ...
 TLine ll;
 ll.SetLineStyle(2);
 ll.DrawLine(2.283,0,2.283,2500);
 ll.DrawLine(2.283+.0913,0,2.283+.0913,2500);

 hist_20Mg_after->SetLineColor(3);
 hist_20Mg_after->Draw("same");
}
