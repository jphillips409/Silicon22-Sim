{
  ...
  tt.DrawLatex(.39,200*.6,"(b) 100 mm");

  canvas.cd(3);
  TH2S frame3("frame3","",10,0,2.8,10,0,150);
  frame3.GetXaxis()->SetTitle("Q_{2p} (MeV)");

  frame3.GetYaxis()->SetTitle("Counts/16 keV");
  ...
  tt.DrawLatex(.39,200*.6,"(c) 110 mm");

  canvas.cd(4);
  TH2S frame4("frame4","",10,0,2.8,10,0,150);
  frame4.GetXaxis()->SetTitle("Q_{2p} (MeV)");

  frame4.GetYaxis()->SetTitle("Counts/16 keV");
  ...
  tt.DrawLatex(.39,200*.6,"(d) 120 mm");

  canvas.cd(5);
  TH2S frame5("frame5","",10,0,2.8,10,0,150);
  frame5.GetXaxis()->SetTitle("Q_{2p} (MeV)");

  frame5.GetYaxis()->SetTitle("Counts/16 keV");
  ...
  tt.DrawLatex(.39,200*.6,"(e) 160 mm");
